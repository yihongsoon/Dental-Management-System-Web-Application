                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <asp:TextBox ID="txtDiagnosis" Text="" runat="server" CssClass="form-control timepicker" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <asp:TextBox ID="txtMedGiven" Text="" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
