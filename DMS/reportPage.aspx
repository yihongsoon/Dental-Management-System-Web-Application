                ...
                <div class="col-md-12">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <div class="row ">
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        ...
                                        <asp:Button ID="btnSearchReport" CssClass="mt-2 btn btn-primary" runat="server" OnClick="btnSearchReport_Click" Text="Search"></asp:Button>
                            ...
                            <div class="alert alert-warning fade show" runat="server" id="noInput" visible="false">
                                <asp:Label runat="server" Text="Please fill in all the field"></asp:Label>
                            </div>
                            <asp:Panel runat="server" ID="pnlsearchResult" Visible="false">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            <asp:GridView ID="gridViewSearchResult" Visible="true" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" PagerStyle-CssClass="pager" CssClass="mydatagrid" OnPageIndexChanging="gridViewSearchResult_PageIndexChanging" OnSelectedIndexChanged="gridViewSearchResult_SelectedIndexChanged"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="reportCategory" HeaderText="Category" ItemStyle-HorizontalAlign="Center">
                                                        <HeaderStyle CssClass="header-centered" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="reportMonth" HeaderText="Month" ItemStyle-HorizontalAlign="Center">
                                                        <HeaderStyle CssClass="header-centered" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="reportYear" HeaderText="Year" ItemStyle-HorizontalAlign="Center">
                                                        <HeaderStyle CssClass="header-centered" />
                                                    </asp:BoundField>
                                                </Columns>
